  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Inset shadows for pressed/inner elements
        'inner-soft': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.08)',
        'inner-medium': 'inset 0 2px 8px 0 rgba(0, 0, 0, 0.12)',
        'inner-strong': 'inset 0 4px 12px 0 rgba(0, 0, 0, 0.16)',
      },
      ...
      // Spacing improvements for better rhythm
      spacing: {
        '18': '4.5rem',
        '22': '5.5rem',
        '26': '6.5rem',
